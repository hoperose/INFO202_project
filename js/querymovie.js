...
// $('#cat1').click( ()=> 
//     getMovieDataOld("movie?cat=1", function(err, data) {
//     if(err) {throw err;}
//     //console.log(data);
//     currCat = "1";
//     updateResult(data); 
...
// $('#cat2').click( ()=> 
//   getMovieDataOld("movie?cat=2", function(err, data) {
//   if(err) {throw err;}
//   //console.log(data);
//   currCat = "2";
//   updateResult(data); 
// }));
// $('#cat3').click( ()=> 
//     getMovieDataOld("movie?cat=3", function(err, data) {
//     if(err) {throw err;}
//     //console.log(data);
//     currCat = "3";
//     updateResult(data); 
// }));
// $('#cat4-1').click( ()=> getMovieDataOld("movie?cat=4-1", function(err, data) {
//     if(err) {throw err;}
//     //console.log(data);
//     currCat = "4-1";
//     updateResult(data); 
// }));
// $('#cat4-2').click( ()=> getMovieDataOld("movie?cat=4-2", function(err, data) {
//     if(err) {throw err;}
//     //console.log(data);
//     currCat = "4-2";
//     updateResult(data); 
// }));
// $('#cat5').click( ()=> getMovieDataOld("movie?cat=5", function(err, data) {
//     if(err) {throw err;}
//     //console.log(data);
//     currCat = "5";
//     updateResult(data); 
// }));
// $('#cat6').click( ()=> getMovieDataOld("movie?cat=6", function(err, data) {
//     if(err) {throw err;}
//     //console.log(data);
//     currCat = "6";
//     updateResult(data); 
// }));
// $('#cat7').click( ()=> getMovieDataOld("movie?cat=7", function(err, data) {
//     if(err) {throw err;}
//     //console.log(data);
//     currCat = "7";
//     updateResult(data); 
// }));
// $('#cat8').click( ()=> getMovieDataOld("movie?cat=8", function(err, data) {
//     if(err) {throw err;}
//     //console.log(data);
//     currCat = "8";
//     updateResult(data); 
